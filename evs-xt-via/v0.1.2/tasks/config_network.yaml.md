...
- name: Configure 10Gbe Interface
  evs_config:
    ...
    config_value: "{{ gigabit_connection }}"
  # loop: "{{ serverVars.config_lines }}"
  ignore_errors: true
