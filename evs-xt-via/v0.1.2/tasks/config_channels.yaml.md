...
- name: Configure Output Channel 1 Name
  evs_config:
    ...
    config_value: "{{ out_channel_1.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 2 Name
  evs_config:
    ...
    config_value: "{{ out_channel_2.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 3 Name
  evs_config:
    ...
    config_value: "{{ out_channel_3.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 4 Name
  evs_config:
    ...
    config_value: "{{ out_channel_4.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 5 Name
  evs_config:
    ...
    config_value: "{{ out_channel_5.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 6 Name
  evs_config:
    ...
    config_value: "{{ out_channel_6.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 1 Name
  evs_config:
    ...
    config_value: "{{ in_channel_1.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 1 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_1.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 1 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_1.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 2 Name
  evs_config:
    ...
    config_value: "{{ in_channel_2.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 2 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_2.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 2 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_2.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 3 Name
  evs_config:
    ...
    config_value: "{{ in_channel_3.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 3 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_3.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 3 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_3.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 4 Name
  evs_config:
    ...
    config_value: "{{ in_channel_4.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 4 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_4.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 4 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_4.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 5 Name
  evs_config:
    ...
    config_value: "{{ in_channel_5.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 5 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_5.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 5 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_5.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 6 Name
  evs_config:
    ...
    config_value: "{{ in_channel_6.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 6 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_6.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 6 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_6.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 7 Name
  evs_config:
    ...
    config_value: "{{ in_channel_7.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 7 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_7.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 7 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_7.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 8 Name
  evs_config:
    ...
    config_value: "{{ in_channel_8.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 8 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_8.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 8 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_8.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 9 Name
  evs_config:
    ...
    config_value: "{{ in_channel_9.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 9 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_9.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 10 Name
  evs_config:
    ...
    config_value: "{{ in_channel_10.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 10 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_10.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 10 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_10.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 11 Name
  evs_config:
    ...
    config_value: "{{ in_channel_11.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 11 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_11.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 11 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_11.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Input Channel 12 Name
  evs_config:
    ...
    config_value: "{{ in_channel_12.name }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 12 Primary Control
  evs_config:
    ...
    config_value: "{{ in_channel_12.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configre Input Channel 12 Primary Port
  evs_config:
    ...
    config_value: "{{ in_channel_12.primary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 1 Control
  evs_config:
    ...
    config_value: "{{ out_channel_1.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 1
...
- name: Configure Output Channel 2 Control
  evs_config:
    ...
    config_value: "{{ out_channel_2.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 2
...
- name: Configure Output Channel 3 Control
  evs_config:
    ...
    config_value: "{{ out_channel_3.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 3
- name: Configure Output Channel 4 Control
  evs_config:
    ...
    config_value: "{{ out_channel_4.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 4
...
- name: Configure Output Channel 5 Control
  evs_config:
    ...
    config_value: "{{ out_channel_5.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 5
...
- name: Configure Output Channel 6 Control
  evs_config:
    ...
    config_value: "{{ out_channel_6.primary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 6
...
- name: Configure Output Channel 1 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_1.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 1
...
- name: Configure Output Channel 1 Secondary Port
  evs_config:
    ...
    config_value: "{{ out_channel_1.secondary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 2 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_2.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 2
...
- name: Configure Output Channel 2 Secondary Port
  evs_config:
    ...
    config_value: "{{ out_channel_2.secondary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 3 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_3.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 3
...
- name: Configure Output Channel 3 Secondary Port
  evs_config:
    ...
    config_value: "{{ out_channel_3.secondary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 4 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_4.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 4
...
- name: Configure Output Channel 4 Secondary Port
  evs_config:
    ...
    config_value: "{{ out_channel_4.secondary_port }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 5 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_5.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 5
...
- name: Configure Output Channel 6 Secondary Control
  evs_config:
    ...
    config_value: "{{ out_channel_6.secondary_control }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 6
...
- name: Configure Output Channel 1 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_1.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 2 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_2.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 3 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_3.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 4 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_4.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 5 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_5.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 6 SMPTE 334M Encoding
  evs_config:
    ...
    config_value: "{{ out_channel_6.smpte_334M_encoding }}"
  # loop: "{{ serverVars.config_lines }}"
...
- name: Configure Output Channel 1 Mix On One Channel
  evs_config:
    ...
    config_value: "{{ out_channel_1.mix_one_channel }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 1
...
- name: Configure Output Channel 2 Mix On One Channel
  evs_config:
    ...
    config_value: "{{ out_channel_2.mix_one_channel }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 2
...
- name: Configure Output Channel 3 Mix On One Channel
  evs_config:
    ...
    config_value: "{{ out_channel_3.mix_one_channel }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 3
...
- name: Configure Output Channel 4 Mix On One Channel
  evs_config:
    ...
    config_value: "{{ out_channel_4.mix_one_channel }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 4
...
- name: Configure Output Channel 5 Mix On One Channel
  evs_config:
    ...
    config_value: "{{ out_channel_5.mix_one_channel }}"
  # loop: "{{ serverVars.config_lines }}"
  when: play_channels | int >= 5
