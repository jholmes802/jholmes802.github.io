...
class LiveIPBase:
    ...
    def setValue(self, value: Any) -> None:
        ...
        self._updateFunc(self.getUri(), value)
...
class LiveIPConfig:
    ...
    def _updateMiddleware(self, uri: str, value: Any):
        # This is a middleware function that is called when a channel is updated
        self._updateFunc(self.getNumLine(), uri, value)

    def _readMiddleware(self, uri: str) -> Any:
        self._readFunc(self.getNumLine(), uri)
